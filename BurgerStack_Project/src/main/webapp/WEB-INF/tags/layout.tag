  ...
  <body>
    <div class="layout__container">
      ...
      <div class="layout__header">
        <a href="" class="layout__header-title"><c:out value="${headerTitle}" /></a>
      ...
      <div class="layout__menubar">
        <div class="layout__menubar-profile-box">
          <div>
            <span class="layout__menubar-profile-name"><c:out value="${sessionScope.loginUser.userName}" /></span>
          ...
          <div class="layout__menubar-profile-role">
            <if test="${role == 'owner'}"><c:out value="${sessionScope.loginUser.storeName}" /></if>
